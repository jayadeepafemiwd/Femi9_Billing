                  ...
                  <div class="radio-group">
                    <label class="radio-option <?php echo e($ctype=='business'?'selected':''); ?>"
                      ...
                      <input type="radio" name="customer_type" value="business"
                             <?php echo e($ctype=='business'?'checked':''); ?>>
                    ...
                    <label class="radio-option <?php echo e($ctype=='individual'?'selected':''); ?>"
                      ...
                      <input type="radio" name="customer_type" value="individual"
                             <?php echo e($ctype=='individual'?'checked':''); ?>>
                  ...
                  <select name="billing[country]">
                    ...
                    <?php $__currentLoopData = ['India','USA','UK']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($c); ?>"
                        <?php echo e(old('billing.country', $billing['country'] ?? '') == $c ? 'selected':''); ?>><?php echo e($c); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                </div>
                <div class="address-form-row">
                  ...
                  <select name="billing[state]">
                    ...
                    <?php $__currentLoopData = ['Tamil Nadu','Karnataka','Maharashtra','Delhi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($s); ?>"
                        <?php echo e(old('billing.state', $billing['state'] ?? '') == $s ? 'selected':''); ?>><?php echo e($s); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                </div>
              </div>
              ...
              <div class="address-section">
                ...
                <div class="address-form-row">
                  ...
                  <select name="shipping[country]">
                    ...
                    <?php $__currentLoopData = ['India','USA','UK']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($c); ?>"
                        <?php echo e(old('shipping.country', $shipping['country'] ?? '') == $c ? 'selected':''); ?>><?php echo e($c); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                </div>
                <div class="address-form-row">
                  ...
                  <select name="shipping[state]">
                    ...
                    <?php $__currentLoopData = ['Tamil Nadu','Karnataka','Maharashtra','Delhi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($s); ?>"
                        <?php echo e(old('shipping.state', $shipping['state'] ?? '') == $s ? 'selected':''); ?>><?php echo e($s); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                </div>
              </div>
              ...
              <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="form-row">
                  <div class="form-label <?php echo e($field->mandatory=='yes'?'required':''); ?>">
                    ...
                    <?php if($field->mandatory=='yes'): ?><span style="color:#e53935;">*</span><?php endif; ?>
                  </div>
                  <div class="form-control">
                    <?php
                    ...
                    <?php switch($field->data_type):
                      ...
                      <?php case ('phone'): ?>  <?php case ('url'): ?>  <?php case ('ip_address'): ?>
                        <input type="<?php echo e($field->data_type=='email'?'email':($field->data_type=='url'?'url':'text')); ?>"
                          ...
                          <select name="<?php echo e($fieldName); ?>" <?php echo e($field->mandatory=='yes'?'required':''); ?>>
                            ...
                            <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($opt); ?>"
                                <?php echo e(($oldVal ?? ($config['default_value'] ?? ''))==$opt?'selected':''); ?>><?php echo e($opt); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </select>
                        <?php else: ?>
                    ...
                    <?php if(!empty($config['help_text'])): ?>
                      <div style="font-size:11px;color:#999;margin-top:4px;"><?php echo e($config['help_text']); ?></div>
                    <?php endif; ?>
                  </div>
                </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
var SAVED_CATEGORY   = <?php echo json_encode($savedCat, 15, 512) ?>;
var SAVED_ASSIGN_LOC = <?php echo json_encode($savedAssignLoc, 15, 512) ?>;
...
async function fetchUsedLocations(categoryName) {
    try {
        var res  = await fetch(
            ...
            + '&exclude_id=<?php echo e($customer->id); ?>',
