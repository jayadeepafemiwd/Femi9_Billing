...
<div class="sidebar">
  ...
  @if(!empty($settings['enable_price_lists']))
    <div class="sidebar-sub-item"
         onclick="window.location='{{ route('price-lists.index') }}'">
      Price Lists
    </div>
  @endif
  @if(!empty($settings['enable_composite_items']))
    <div class="sidebar-sub-item"
         onclick="window.location='{{ route('composite-items.index') }}'">
      Composite Items
    </div>
  @endif
</div>
        ...
        <div style="display:flex;gap:32px;margin-bottom:28px;">
          <div style="flex:1;">
            ...
            <div class="form-row">
              ...
              <input type="text" name="name" class="name-input" value="{{ old('name') }}" required />
      ...
      🔒 This product show only for the <strong style="color:#2d5be3;">Admin</strong>
            ...
            <div class="form-row">
              ...
              @switch($field->data_type)
                @case('integer') @case('decimal') @case('float') @case('currency') @case('percentage')
                  <input type="number" name="{{ $fieldName }}" value="{{ $oldValue ?? $config['default_value'] ?? '' }}" step="{{ in_array($field->data_type, ['decimal','float','currency','percentage']) ? '0.01' : '1' }}" placeholder="{{ $config['help_text'] ?? '' }}" {{ $field->mandatory == 'yes' ? 'required' : '' }} style="flex:1;" />
                @break
                @case('date')
                  <input type="date" name="{{ $fieldName }}" value="{{ $oldValue ?? '' }}" {{ $field->mandatory == 'yes' ? 'required' : '' }} style="flex:1;" />
                @break
                @case('datetime')
                  <input type="datetime-local" name="{{ $fieldName }}" value="{{ $oldValue ?? '' }}" {{ $field->mandatory == 'yes' ? 'required' : '' }} style="flex:1;" />
                @break
                @case('boolean')
                  <div class="radio-group">
                    <label class="radio-option"><input type="radio" name="{{ $fieldName }}" value="1" {{ ($oldValue ?? $config['default_value'] ?? '') == '1' ? 'checked' : '' }} /> Yes</label>
                    <label class="radio-option"><input type="radio" name="{{ $fieldName }}" value="0" {{ ($oldValue ?? $config['default_value'] ?? '0') == '0' ? 'checked' : '' }} /> No</label>
                  </div>
                @break
                @case('array')
                  <div class="select-wrap">
                ...
                @break
                @default
                  <input type="{{ in_array($field->data_type, ['email']) ? 'email' : (in_array($field->data_type, ['phone']) ? 'tel' : 'text') }}" name="{{ $fieldName }}" value="{{ $oldValue ?? $config['default_value'] ?? '' }}" placeholder="{{ $config['help_text'] ?? '' }}" {{ $field->mandatory == 'yes' ? 'required' : '' }} @if(!empty($config['char_limit'])) maxlength="{{ $config['char_limit'] }}" @endif style="flex:1;" />
              @endswitch
            </div>
          @endforeach
        @endif
        ...
        <div class="form-row" style="margin-bottom:18px;">
          ...
          <div class="item-type-group">
            <div class="item-type-btn {{ old('item_variant_type','single')=='single'?'active':'' }}" onclick="selectItemType('single',this)">
              <div class="radio-dot {{ old('item_variant_type','single')=='single'?'active':'' }}" id="dot-single"><div class="radio-dot-inner"></div></div>Single Item
            </div>
            <div class="item-type-btn {{ old('item_variant_type')=='contains_variants'?'active':'' }}" onclick="selectItemType('variants',this)">
              <div class="radio-dot {{ old('item_variant_type')=='contains_variants'?'active':'' }}" id="dot-variants"></div>Contains Variants
            </div>
          </div>
...
@enderror
          ...
          <div class="form-row single-only" id="sku-row" style="margin-bottom:0;">
            ...
            <input type="text" name="sku" style="flex:1;" value="{{ old('sku') }}" />
          </div>
        </div>

        {{-- Add Identifier — Single Item only --}}
        ...
        <div class="identifier-fields single-only" id="identifier-fields">
          <div class="identifier-grid">
            <div class="identifier-row"><label>UPC</label><input type="text" name="upc" value="{{ old('upc') }}" /></div>
            <div class="identifier-row"><label>MPN</label><input type="text" name="mpn" value="{{ old('mpn') }}" /></div>
            <div class="identifier-row"><label>EAN</label><input type="text" name="ean" value="{{ old('ean') }}" /></div>
            <div class="identifier-row"><label>ISBN</label><input type="text" name="isbn" value="{{ old('isbn') }}" /></div>
          </div>
        </div>
        ...
        <div class="form-row" style="margin-top:16px;">
          ...
          <textarea name="items_description" style="flex:1;" placeholder="Enter item description...">{{ old('items_description') }}</textarea>
        </div>
  ...
  <tr>
    ...
    <th style="width:80px;"></th>
          ...
          {{-- Hidden JSON field — variants data --}}
        ...
        <div class="section-title">
          <input type="checkbox" id="chk-sales" name="has_sales" value="1" {{ old('has_sales',true)?'checked':'' }} onchange="toggleSection('chk-sales','sales-body')" />
          <h3>Sales Information</h3>
        </div>
        <div class="section-body {{ old('has_sales',true)?'':'hidden' }}" id="sales-body">
          {{-- Single Item: Selling Price shown --}}
          <div class="two-col single-only" id="selling-price-row" style="margin-bottom:14px;">
            <div class="form-row" style="margin-bottom:0;">
              ...
              <div class="inr-wrap"><span class="inr-prefix">INR</span><input type="number" name="selling_price" step="0.01" value="{{ old('selling_price') }}" /></div>
            </div>
          </div>
          {{-- Variants: Account only --}}
          ...
          <div class="form-row">
            ...
            <textarea name="sales_description" style="flex:1;" placeholder="Description shown on sales documents...">{{ old('sales_description') }}</textarea>
          </div>
        </div>
        ...
        <div class="section-title">
          <input type="checkbox" id="chk-purchase" name="has_purchase" value="1" {{ old('has_purchase',true)?'checked':'' }} onchange="toggleSection('chk-purchase','purchase-body')" />
          <h3>Purchase Information</h3>
        </div>
        <div class="section-body {{ old('has_purchase',true)?'':'hidden' }}" id="purchase-body">
          {{-- Single Item: Cost Price shown --}}
          <div class="two-col single-only" id="cost-price-row" style="margin-bottom:14px;">
            <div class="form-row" style="margin-bottom:0;">
              ...
              <div class="inr-wrap"><span class="inr-prefix">INR</span><input type="number" name="cost_price" step="0.01" value="{{ old('cost_price') }}" /></div>
            </div>
          </div>
          {{-- Variants: Account only --}}
          ...
          <div class="two-col">
            <div class="form-row">
              ...
              <textarea name="purchase_description" style="flex:1;" placeholder="Description shown on purchase documents...">{{ old('purchase_description') }}</textarea>
            </div>
            <div class="form-row" style="margin-bottom:0;">
        ...
        <!-- Track Inventory -->
        <div class="section-title">
          <input type="checkbox" id="chk-track" name="track_inventory" value="1" {{ old('track_inventory',true)?'checked':'' }} onchange="toggleSection('chk-track','track-body')" />
        ...
        <div class="section-body {{ old('track_inventory',true)?'':'hidden' }}" id="track-body">
          <div class="form-row" style="margin-bottom:16px;">
            <label class="field-label" style="width:200px;text-align:left;">Bin Location Tracking</label>
            <div class="radio-group">
              <label class="radio-option"><input type="radio" name="bin_location_tracking" value="1" {{ old('bin_location_tracking')=='1'?'checked':'' }} /> Yes</label>
              <label class="radio-option {{ old('bin_location_tracking')!='1'?'checked':'' }}"><input type="radio" name="bin_location_tracking" value="0" {{ old('bin_location_tracking')!='1'?'checked':'' }} /> No</label>
            </div>
          </div>
          ...
          <div class="form-row">
            ...
            <input type="text" name="reorder_point" step="0.01" style="width:300px;" value="{{ old('reorder_point') }}" />
          </div>
        </div>
        ...
        <div class="form-row">
          ...
          <div class="radio-group">
            <label class="radio-option {{ old('is_returnable','1')=='1'?'checked':'' }}"><input type="radio" name="is_returnable" value="1" {{ old('is_returnable','1')=='1'?'checked':'' }} /> Yes</label>
            <label class="radio-option {{ old('is_returnable')=='0'?'checked':'' }}"><input type="radio" name="is_returnable" value="0" {{ old('is_returnable')=='0'?'checked':'' }} /> No</label>
          </div>
        </div>
        ...
        <div class="single-only" id="fulfilment-wrap">
          ...
          <div class="two-col">
            <div>
              <div class="form-row" style="margin-bottom:4px;">
                ...
                <div style="display:flex;gap:6px;align-items:center;">
                  <input type="number" name="custom_field[length]" step="0.01" style="width:80px;" value="{{ old('custom_field.length') }}" placeholder="L" />
                  <span style="color:#aaa;">x</span>
                  <input type="number" name="custom_field[width]" step="0.01" style="width:80px;" value="{{ old('custom_field.width') }}" placeholder="W" />
                  <span style="color:#aaa;">x</span>
                  <input type="number" name="custom_field[height]" step="0.01" style="width:80px;" value="{{ old('custom_field.height') }}" placeholder="H" />
            ...
            <div class="form-row" style="margin-bottom:0;">
              ...
              <input type="number" name="custom_field[weight]" step="{{ $wStep }}" style="width:180px;" value="{{ old('custom_field.weight') }}" />
      ...
      @if(isset($customFields) && $customFields->count() > 0)
        ...
        @foreach($customFields as $field)
          <div class="addl-custom-row">
            ...
            <input type="text" id="addl-cf-{{ $field->id }}" data-field-id="{{ $field->id }}" />
          </div>
        @endforeach
      @endif
    </div>
