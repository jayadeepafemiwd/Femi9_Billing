...
<label class="radio-option {{ old('customer_type', $config['default_customer_type'] ?? 'business') == 'business' ? 'selected' : '' }}" id="opt-business" onclick="selectCustomerType('business')">                   
<input type="radio" name="customer_type" value="business" {{ old('customer_type', $config['default_customer_type'] ?? 'business') == 'business' ? 'checked' : '' }}>
                    <span class="radio-dot"></span> Business
                  </label>
<label class="radio-option {{ old('customer_type', $config['default_customer_type'] ?? 'business') == 'individual' ? 'selected' : '' }}" id="opt-individual" onclick="selectCustomerType('individual')">                 
<input type="radio" name="customer_type" value="individual" {{ old('customer_type', $config['default_customer_type'] ?? 'business') == 'individual' ? 'checked' : '' }}>                    <span class="radio-dot"></span> Individual
                  </label>
                </div>
              </div>
            </div>
        ...
        {{-- Customer Category --}}
<div class="form-row" id="row-customerCategory" style="{{ old('customer_type')=='individual'?'display:none':'' }}">
  ...
  <div class="form-control" style="max-width:420px;">
    ...
    <input type="hidden" name="customer_sub_category_id" id="customerSubCatId" value="{{ old('customer_sub_category_id') }}">
    {{-- Custom dropdown --}}
    <div class="pl-cat-dropdown" id="custCatDropdown">
      ...
      <div id="custCatList"
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;
            ...
            data-name="{{ $cat->name }}"
            data-id="{{ $cat->id }}"
            data-layer-id="{{ $cat->assign_fix_location }}"
             data-country-id="{{ $cat->country_id }}"
             data-loc="{{ $cat->location_label }}"
             onclick="selectCustCat(this)"
             onmouseover="this.style.background='#f0f4ff'"
             onmouseout="this.style.background='#fff'">
          <span style="font-weight:500;color:#333;">{{ $cat->name }}</span>
  ...
  <div style="background:#f8f9ff;border:1px solid #dce8ff;border-radius:8px;padding:10px 12px;">
    ...
    <div id="subCatChips" style="display:flex;flex-wrap:wrap;gap:6px;">
      <span style="font-size:12px;color:#aaa;">Loading...</span>
            ...
            <div class="form-row">
              ...
              <div class="form-control">
                <div class="inline-group">
                  ...
                  <input type="text" name="first_name" id="firstName" placeholder="First Name" value="{{ old('first_name') }}" oninput="refreshDisplaySuggestions()" style="flex:1;">
                  <input type="text" name="last_name"  id="lastName"  placeholder="Last Name"  value="{{ old('last_name') }}"  oninput="refreshDisplaySuggestions()" style="flex:1;">
                </div>
              </div>
            </div>

            {{-- Company Name --}}
            <div class="form-row" id="row-companyName" style="{{ old('customer_type')=='individual'?'display:none':'' }}">
            ...
            <div class="form-row">
              ...
              <div class="form-control">
                <div class="phone-group">
                  ...
                  <input type="text" name="phone_number" placeholder="Work Phone" class="phone-input" value="{{ old('phone_number') }}">
                  <div class="phone-country"><select><option>+91</option><option>+1</option><option>+44</option></select></div>
                  <input type="text" name="mobile" placeholder="Mobile" class="phone-input" value="{{ old('mobile') }}">
                </div>
              </div>
            </div>
        ...
        <div class="tab" onclick="showTab('assignLocation',this)">Assign Location</div>  {{-- ✅ NEW --}}
        ...
        <div id="tab-otherDetails" class="form-body tab-content" style="display:block;">
          <div class="form-row">
            ...
            <div class="form-control"><input type="text" name="pan" maxlength="10" style="max-width:200px;text-transform:uppercase;" value="{{ old('pan') }}"></div>
          </div>
          <div class="form-row">
          ...
          <div class="form-row">
            ...
            <div class="form-control" style="max-width:320px;">
              <select name="payment_terms">
                <option value="Due on Receipt" {{ old('payment_terms','Due on Receipt')=='Due on Receipt'?'selected':'' }}>Due on Receipt</option>
          ...
          <div class="form-row">
            ...
            <div class="form-control">
              <label class="portal-check">
                <input type="checkbox" name="enable_portal" value="1" {{ old('enable_portal')?'checked':'' }}>
            ...
            <div class="form-row">
              ...
              <div class="form-control">
                <div class="website-wrapper">
                  ...
                  <input type="url" name="website" placeholder="ex: https://www.example.com" value="{{ old('website') }}">
                </div>
              </div>
            </div>
            <div class="form-row">
              <div class="form-label">Department</div>
              <div class="form-control"><input type="text" name="department" value="{{ old('department') }}"></div>
            </div>
            <div class="form-row">
              <div class="form-label">Designation</div>
              <div class="form-control"><input type="text" name="designation" value="{{ old('designation') }}"></div>
            </div>
            <div class="form-row">
              ...
              <div class="form-control">
                <div class="social-row">
                  ...
                  <input type="text" name="twitter" class="social-input" value="{{ old('twitter') }}">
                </div>
              </div>
            </div>
            <div class="form-row">
              ...
              <div class="form-control">
                <div class="social-row">
                  ...
                  <input type="text" name="skype" class="social-input" value="{{ old('skype') }}">
                </div>
              </div>
            </div>
            <div class="form-row">
              ...
              <div class="form-control">
                <div class="social-row">
                  ...
                  <input type="text" name="facebook" class="social-input" value="{{ old('facebook') }}">
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="tab-address" class="form-body tab-content">
          <div class="address-grid">
            <div class="address-section">
              ...
              <div class="address-form-row"><label>Attention</label><input type="text" name="billing[attention]" value="{{ old('billing.attention') }}"></div>
              <div class="address-form-row"><label>Country/Region</label>
                <select name="billing[country]">
                  ...
                  <option value="USA"   {{ old('billing.country')=='USA'  ?'selected':'' }}>USA</option>
                  <option value="UK"    {{ old('billing.country')=='UK'   ?'selected':'' }}>UK</option>
                </select>
              </div>
              <div class="address-form-row"><label>Street 1</label><textarea name="billing[street1]">{{ old('billing.street1') }}</textarea></div>
              <div class="address-form-row"><label>Street 2</label><textarea name="billing[street2]">{{ old('billing.street2') }}</textarea></div>
              <div class="address-form-row"><label>City</label><input type="text" name="billing[city]" value="{{ old('billing.city') }}"></div>
              <div class="address-form-row"><label>State</label>
                <select name="billing[state]">
                  <option value="">Select</option>
                  <option value="Tamil Nadu"  {{ old('billing.state')=='Tamil Nadu' ?'selected':'' }}>Tamil Nadu</option>
                  <option value="Karnataka"   {{ old('billing.state')=='Karnataka'  ?'selected':'' }}>Karnataka</option>
                  <option value="Maharashtra" {{ old('billing.state')=='Maharashtra'?'selected':'' }}>Maharashtra</option>
                  <option value="Delhi"       {{ old('billing.state')=='Delhi'      ?'selected':'' }}>Delhi</option>
                </select>
              </div>
              <div class="address-form-row"><label>Pin Code</label><input type="text" name="billing[pincode]" value="{{ old('billing.pincode') }}"></div>
              <div class="address-form-row"><label>Phone</label><input type="text" name="billing[phone]" value="{{ old('billing.phone') }}"></div>
              <div class="address-form-row"><label>Fax</label><input type="text" name="billing[fax]" value="{{ old('billing.fax') }}"></div>
            </div>
            <div class="address-section">
              <h4>Shipping Address <a href="#" onclick="copyBilling();return false;">↓ Copy billing address</a></h4>
              <div class="address-form-row"><label>Attention</label><input type="text" name="shipping[attention]" value="{{ old('shipping.attention') }}"></div>
              <div class="address-form-row"><label>Country/Region</label>
                <select name="shipping[country]">
                  <option value="">Select</option>
                  <option value="India" {{ old('shipping.country')=='India'?'selected':'' }}>India</option>
                  <option value="USA"   {{ old('shipping.country')=='USA'  ?'selected':'' }}>USA</option>
                  <option value="UK"    {{ old('shipping.country')=='UK'   ?'selected':'' }}>UK</option>
                </select>
              </div>
              <div class="address-form-row"><label>Street 1</label><textarea name="shipping[street1]">{{ old('shipping.street1') }}</textarea></div>
              <div class="address-form-row"><label>Street 2</label><textarea name="shipping[street2]">{{ old('shipping.street2') }}</textarea></div>
              <div class="address-form-row"><label>City</label><input type="text" name="shipping[city]" value="{{ old('shipping.city') }}"></div>
              <div class="address-form-row"><label>State</label>
                <select name="shipping[state]">
                  <option value="">Select</option>
                  <option value="Tamil Nadu"  {{ old('shipping.state')=='Tamil Nadu' ?'selected':'' }}>Tamil Nadu</option>
                  <option value="Karnataka"   {{ old('shipping.state')=='Karnataka'  ?'selected':'' }}>Karnataka</option>
                  <option value="Maharashtra" {{ old('shipping.state')=='Maharashtra'?'selected':'' }}>Maharashtra</option>
                  <option value="Delhi"       {{ old('shipping.state')=='Delhi'      ?'selected':'' }}>Delhi</option>
                </select>
              </div>
              <div class="address-form-row"><label>Pin Code</label><input type="text" name="shipping[pincode]" value="{{ old('shipping.pincode') }}"></div>
              <div class="address-form-row"><label>Phone</label><input type="text" name="shipping[phone]" value="{{ old('shipping.phone') }}"></div>
              <div class="address-form-row"><label>Fax</label><input type="text" name="shipping[fax]" value="{{ old('shipping.fax') }}"></div>
            </div>
          </div>
      ...
      <div class="form-row">
        ...
        <div class="form-control">
          ...
          @switch($field->data_type)
            ...
            @case('ip_address')
              <input
                type="{{ $field->data_type == 'email' ? 'email' : ($field->data_type == 'url' ? 'url' : 'text') }}"
                name="{{ $fieldName }}"
                value="{{ $oldVal ?? ($fieldConfig['default_value'] ?? '') }}"
                {{ $field->mandatory == 'yes' ? 'required' : '' }}
                @if(!empty($fieldConfig['char_limit'])) maxlength="{{ $fieldConfig['char_limit'] }}" @endif
            ...
            @case('longtext')
              <textarea
                ...
                {{ $field->mandatory == 'yes' ? 'required' : '' }}
                placeholder="{{ $fieldConfig['help_text'] ?? '' }}"
              >{{ $oldVal ?? ($fieldConfig['default_value'] ?? '') }}</textarea>
            @break
            ...
            @case('boolean')
              <label class="portal-check">
                <input
                  ...
                  name="{{ $fieldName }}"
                  value="1"
                  {{ ($oldVal ?? ($fieldConfig['default_value'] ?? '')) == '1' ? 'checked' : '' }}
                >
                {{ $fieldConfig['help_text'] ?? $field->name }}
              </label>
            @break
            ...
            @case('date')
              <input
                type="date"
                name="{{ $fieldName }}"
                value="{{ $oldVal ?? ($fieldConfig['default_date'] ?? '') }}"
                {{ $field->mandatory == 'yes' ? 'required' : '' }}
            ...
            @case('time')
              <input
                type="time"
                name="{{ $fieldName }}"
                value="{{ $oldVal ?? ($fieldConfig['default_time'] ?? '') }}"
                {{ $field->mandatory == 'yes' ? 'required' : '' }}
              ...
              @if(count($options))
                <select name="{{ $fieldName }}" {{ $field->mandatory == 'yes' ? 'required' : '' }}>
                  ...
                  @foreach($options as $opt)
                    <option value="{{ $opt }}"
                      {{ ($oldVal ?? ($fieldConfig['default_value'] ?? '')) == $opt ? 'selected' : '' }}>
                      {{ $opt }}
                    </option>
                  @endforeach
                </select>
          ...
          {{-- Help text --}}
          @if(!empty($fieldConfig['help_text']))
    ...
    <span class="loc-loading">Loading...</span>
        ...
        <div id="tab-remarks" class="form-body tab-content">
          <div class="form-row">
            ...
            <div class="form-control" style="max-width:600px;"><textarea name="remarks" rows="6">{{ old('remarks') }}</textarea></div>
          </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var savedType   = "{{ old('customer_type') }}";
