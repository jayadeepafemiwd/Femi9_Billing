    ...
    <div class="settings-body">
        ...
        <div class="main-content">
            ...
            <div class="form-content">
               ...
               <form action="{{ route('customers-vendors.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-section">
                        <div class="checkbox-row">
                            <input type="checkbox" id="allow_duplicates" name="allow_duplicates" value="1"
                                {{ old('allow_duplicates', $config['allow_duplicates'] ?? false) ? 'checked' : '' }}>
                        ...
                        <div class="radio-group">
                            <div class="radio-row">
                                <input type="radio" id="type_business" name="default_customer_type" value="business"
                                    {{ old('default_customer_type', $config['default_customer_type'] ?? 'business') === 'business' ? 'checked' : '' }}>
                                <label for="type_business">Business</label>
                            </div>
                            <div class="radio-row">
                                <input type="radio" id="type_individual" name="default_customer_type" value="individual"
                                    {{ old('default_customer_type', $config['default_customer_type'] ?? 'business') === 'individual' ? 'checked' : '' }}>
                    ...
                    <div class="form-section">
                        <div class="toggle-row">
                            ...
                            <div class="toggle-right">
                                <span class="toggle-status" id="credit-limit-status">
                                    {{ old('customer_credit_limit', $config['customer_credit_limit'] ?? false) ? 'Enabled' : 'Disabled' }}
                                </span>
                                <label class="toggle-switch">
                                    <input type="checkbox"
                                           ...
                                           value="1"
                                           {{ old('customer_credit_limit', $config['customer_credit_limit'] ?? false) ? 'checked' : '' }}
                        ...
                        <div id="credit-limit-expanded"
                             class="credit-limit-expanded {{ old('customer_credit_limit', $config['customer_credit_limit'] ?? false) ? 'visible' : '' }}">
                            ...
                            <div class="radio-group">
                                <div class="radio-row">
                                    <input type="radio" id="credit_restrict" name="credit_limit_action" value="restrict"
                                        {{ old('credit_limit_action', $config['credit_limit_action'] ?? 'warn') === 'restrict' ? 'checked' : '' }}>
                                ...
                                <div class="radio-row">
                                    <input type="radio" id="credit_warn" name="credit_limit_action" value="warn"
                                        {{ old('credit_limit_action', $config['credit_limit_action'] ?? 'warn') === 'warn' ? 'checked' : '' }}>
                            ...
                            <div class="checkbox-row" style="margin-top: 14px;">
                                <input type="checkbox" id="include_sales_orders" name="include_sales_orders" value="1"
                                    {{ old('include_sales_orders', $config['include_sales_orders'] ?? true) ? 'checked' : '' }}>
                                <div>
                        ...
                        <div class="address-format-wrapper">
                            <div class="address-format-box">
                                ...
                                <textarea name="billing_address_format"
                                          ...
                                          class="address-textarea">{{ old('billing_address_format', $config['billing_address_format'] ?? '${CONTACT.CONTACT_DISPLAYNAME}
                        ...
                        <div class="address-format-wrapper">
                            <div class="address-format-box">
                                ...
                                <textarea name="shipping_address_format"
                                          ...
                                          class="address-textarea">{{ old('shipping_address_format', $config['shipping_address_format'] ?? '${CONTACT.CONTACT_ADDRESS}
${CONTACT.CONTACT_CITY}
${CONTACT.CONTACT_CODE} ${CONTACT.CONTACT_STATE}
${CONTACT.CONTACT_COUNTRY}') }}</textarea>
                            </div>
