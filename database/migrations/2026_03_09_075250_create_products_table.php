...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            // ── Basic Info ──────────────────────────────────────────
            $table->string('name');
             $table->enum('item_type', ['item', 'composite_item'])->default('item');
            $table->enum('type', ['goods', 'service','assembly_item','kit_item'])->default('goods');
            ...
            $table->json('associate_item_details')->nullable()->comment('Composite associate item detaila');
